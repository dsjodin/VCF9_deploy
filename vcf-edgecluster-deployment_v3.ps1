...
#
#Version 2.2 - Fixed string formatting error in Wait-VCFTask
#
            ...
            switch ($status.ToUpper()) {
                ...
                default {
                    ...
                    if ($shouldLog -or $lastSubtaskStatus -eq "") {
                        # FIX: Cast [math]::Floor() result to [int] for :D2 format specifier
                        $elapsedStr = "{0:D2}:{1:D2}" -f [int][math]::Floor($elapsed.TotalMinutes), $elapsed.Seconds
